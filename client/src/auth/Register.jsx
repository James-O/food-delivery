...
import avater from '../assets/cakelogo.jpg'
...
const Register = () => {
  ...
  return (
    <div className='h-screen mx-auto pt-[20vh]'>
      <form className='ease-in duration-300 w-[80%] mx-auto shadow-sm backdrop-blur-md bg-white/80 lg:w-[50%] items-center rounded-md px-10 py-8' onSubmit={handleRegister}>
        ...
        <button className='bg-[#f54748] activee:scale-90 transition duration-150 transform hover:shadow-xl shadow-md rounded px-8 py-2 text-xl font-medium text-white grid mx-auto w-[100%]' type='submit'>
          Register
        </button>
         
        <Link to={'/login'} className='block text-center font-semibold py-4'>Have an account? <span className='text-[#fdc55e] underline'> Login</span></Link>
