...
import header from '../assets/womenchicken2.jpg'
                ...
                <div className='grid grid-col-1 relative lg:grid-cols-2 gap-8 items-center'>
                    <div className='lg:w-[32rem] w-full flex flex-col space-y-6'>
                        <div className='text-4xl md:text-5xl font-bold text-[#2e2e2e] lg:text-6xl'>
                            We are <span className='text-[#f54748]'> Serious </span> For <span className='#f54748'> Food </span> & <span className='text-[#fdc55e]'> Delivery.</span>
                        </div>
                        ...
                        <div className='flex rounded-full py-2 px-4 justify-between items-center bg-white shawow-md'>
                    ...
                    <img src={header} className='h-[28rem] mx-auto justify-end rounded border-white border-8' alt='chicken' />
                </div>
            </div>
        </div>
    )
